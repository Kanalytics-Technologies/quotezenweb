...
# }
#
# resource "aws_api_gateway_method_response" "signin_method_response_quotezen" {
#   rest_api_id = aws_api_gateway_rest_api.api_auth_quotezen.id
#   resource_id = aws_api_gateway_resource.signin_quotezen.id
#   http_method = aws_api_gateway_method.signin_method_quotezen.http_method
#   status_code = "200"
...
# }
#
# resource "aws_api_gateway_integration_response" "signin_method_integration_response_quotezen" {
#   rest_api_id = aws_api_gateway_rest_api.api_auth_quotezen.id
#   resource_id = aws_api_gateway_resource.signin_quotezen.id
#   http_method = aws_api_gateway_method.signin_method_quotezen.http_method
#   status_code = "200"
...
#   }
#
#   depends_on = [aws_api_gateway_integration.signin_integration_quotezen]
# }
#
